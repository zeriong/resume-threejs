...
// 문으로 비추는 빛
export const toDoorLight = new THREE.SpotLight(0xFFDDAA, 100);
...
// 창문으로 비추는 빛
export const toWindowLight = new THREE.SpotLight(0xFFDDAA, 100);
...
// 오른쪽 측면에서 전체적으로
export const fromRightLight = new THREE.SpotLight(0xFFF0F7, 200);
...
// 높이서 아래로
export const fromSkyLight = new THREE.SpotLight(0xffffff, 100);
...
// 전체를 은은하게 비추는 포인트
export const ambientPointLight = new THREE.PointLight(0xffffff, 14, 20);
...
// 모델 내부를 밝히는 조명
export const innerLight = new THREE.PointLight(0xFFBBCC, 8.5, 6);
