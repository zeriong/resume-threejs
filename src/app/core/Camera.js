...
export default class Camera {
    ...
    setCameraPosition() {
        ...
        this.cameraPosition = [
            (this.windowSizes.width <= 497) ? (-296 * fixCamPosition()) : (-2400 * fixCamPosition()),
            (this.windowSizes.width <= 497) ? (1063 * fixCamPosition()) : (1440 * fixCamPosition()),
            (this.windowSizes.width <= 497) ? (3098 * fixCamPosition()) : (1400 * fixCamPosition()),
        ]
    }
    ...
    createControls() {
        ...
        this.orbitControls.maxDistance = 5000; // 멀어지는 최대거리를 설정
        this.orbitControls.minDistance = 500; // 가까워지는 최소거리 설정
        ...
        this.orbitControls.target.set(0, 150, 0);
